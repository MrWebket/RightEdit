...
#ifndef RIGHTHELPER_NV21RGBA_H
#define RIGHTHELPER_NV21RGBA_H
static const char * nv21rgba_vs = "#version 300 es\n"
...
static const char * nv21rgba_fs = "#version 300 es\n"
                                   ...
                                   "        yuv.y = texture(utexture1, v_texCoord).a - 0.5;\n"
                                   "        yuv.z = texture(utexture1, v_texCoord).r - 0.5;\n"
...
static const char * nv21rgba_alpha_fs = "#version 300 es\n"
                                        "precision highp float;\n"
                                        "in vec2 v_texCoord;\n"
                                        "layout(location = 0) out vec4 outColor;\n"
                                        "uniform sampler2D utexture0;\n"
                                        ...
                                        "        yuv.y = texture(utexture1, rgbCoord).a - 0.5;\n"
                                        "        yuv.z = texture(utexture1, rgbCoord).r - 0.5;\n"
                                        "        highp vec3 rgb = mat3(1.0,       1.0,     1.0,\n"
                                        "        0.0, \t-0.344, \t1.770,\n"
                                        "        1.403,  -0.714,     0.0) * yuv;\n"
...
static const char * nv21rgba_vap_fs = "#version 300 es\n"
                                        "precision highp float;\n"
                                        "in vec2 v_texCoord;\n"
                                        "layout(location = 0) out vec4 outColor;\n"
                                        "uniform sampler2D utexture0;\n"
